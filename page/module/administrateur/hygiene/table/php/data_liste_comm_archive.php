...
if ($job != '') {
    if ($job == 'get_liste_comm') {
        ...
        while ($communication = $PDO_query_comm->fetch()) {
            ...
            <a href="modif_comm_archive.php?id='.$communication['etai_intranet_comm_id'].'" style="font-size: 1.5rem !important;" class="btn waves-effect waves-float waves-light mr-25 mb-25 p-0">
                <i class="bi bi-pencil-square"></i>
            </a>
            <a href="prev_comm_archive.php?id='.$communication['etai_intranet_comm_id'].'" style="font-size: 1.5rem !important;" class="btn waves-effect waves-float waves-light mr-25 mb-25 p-0">
            ...
            <a href="liste_comm_lecteur.php?id='.$communication['etai_intranet_comm_id'].'" style="font-size: 1.5rem !important;" class="btn waves-effect waves-float waves-light mr-25 mb-25 p-0">
