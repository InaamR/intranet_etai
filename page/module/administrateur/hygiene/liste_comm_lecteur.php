...
if(!empty($_GET["id"])){$id_comm_lecteur = $_GET["id"];}else{$id_comm_lecteur = "";}


$PDO_query_comm_unique = Bdd::connectBdd()->prepare("SELECT * FROM etai_intranet_comm WHERE etai_intranet_comm_id = :id_com");
$PDO_query_comm_unique->bindParam(":id_com", $id_comm_lecteur, PDO::PARAM_INT);
$PDO_query_comm_unique->execute();
$comm = $PDO_query_comm_unique->fetch();
...
<head>
    ...
    <title>Communications Générale - Liste des lecteurs - <?php echo $comm['etai_intranet_comm_titre'];?></title>
...
<body class="vertical-layout vertical-menu-modern navbar-floating footer-static menu-collapsed" data-open="click" data-menu="vertical-menu-modern" data-col="">
            ...
            <div class="content-header row">
                    ...
                    <div class="row breadcrumbs-top">
                        <div class="col-12">
                            ...
                            <div class="breadcrumb-wrapper">
                                <ol class="breadcrumb">
                                    <li class="breadcrumb-item"><a href="http://<?php echo $_SERVER['SERVER_NAME']?>/intranet_etai/page/module/administrateur/communication/liste_comm.php">Communications générales</a></li>
                                    <li class="breadcrumb-item"><a href="modif_comm.php?id=<?php echo $id_comm_lecteur;?>"><?php echo $comm['etai_intranet_comm_titre'];?></a></li>
                ...
                <div class="content-header-right text-md-right col-md-3 col-12 d-md-block d-none">
                    <div class="form-group breadcrumb-right">
                        <a class="btn-icon btn btn-primary btn-round btn-sm waves-effect waves-float waves-light" href="liste_comm.php">Revenir à la liste des communications</a>
                    </div>
                </div>
            </div>
                    ...
                    <div class="col-12">
                        ...
                        <section id="basic-datatable">
                            <div class="row">
                                <div class="col-12">
                                    <div class="card">
                                        <table class="datatables-basic table" id="datatable" data-id="<?php echo $_GET['id']; ?>">
                                            <thead>
                                                <tr>
                                                    <th></th>
                                                    <th></th>
    ...
    <!-- BEGIN: Page JS-->
    <script charset="utf-8"  src="<?php echo Admin::menucomm();?>table/js/webapp_liste_comm_lecteur.js"></script>
