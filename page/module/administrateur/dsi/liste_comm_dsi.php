...
<head>
    ...
    <title>Direction Systèmes d'Information</title>
...
<body class="vertical-layout vertical-menu-modern navbar-floating footer-static" data-open="click" data-menu="vertical-menu-modern" data-col="">
                    ...
                    <div class="row breadcrumbs-top">
                        <div class="col-12">
                            ...
                            <div class="breadcrumb-wrapper">
                                <ol class="breadcrumb">
                                    <li class="breadcrumb-item">Direction Systèmes d'Information</li>
                                </ol>
                            </div>
                        </div>
                    </div>
    ...
    <!-- BEGIN: Page JS-->
    <script charset="utf-8"  src="<?php echo Admin::menusug();?>table/js/webapp_liste_comm.js"></script>
